(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_pages_CreateTransaction_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/CreateTransaction.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/CreateTransaction.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _mixins_validationHandler_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../mixins/validationHandler.js */ "./resources/js/mixins/validationHandler.js");
...
/* harmony import */ var _partials_FormErrors_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../partials/FormErrors.vue */ "./resources/js/components/partials/FormErrors.vue");
/* harmony import */ var _partials_VCurrencyField_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../partials/VCurrencyField.vue */ "./resources/js/components/partials/VCurrencyField.vue");
/* harmony import */ var _partials_SearchSymbolField_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../partials/SearchSymbolField.vue */ "./resources/js/components/partials/SearchSymbolField.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [_mixins_validationHandler_js__WEBPACK_IMPORTED_MODULE_2__.default, _mixins_loadingHandler_js__WEBPACK_IMPORTED_MODULE_3__.default],
  components: {
    FormErrors: _partials_FormErrors_vue__WEBPACK_IMPORTED_MODULE_4__.default,
    VCurrencyField: _partials_VCurrencyField_vue__WEBPACK_IMPORTED_MODULE_5__.default,
    SearchSymbolField: _partials_SearchSymbolField_vue__WEBPACK_IMPORTED_MODULE_6__.default
  },
  ...
  data: function data() {
    return {
      ...
      form: {
        ...
        type: _store_constants_js__WEBPACK_IMPORTED_MODULE_0__.TRANSACTION_TYPES.Buying,
        date_at: null,
        symbol_id: 0,
        preference: null,
        lot: null,
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_7__.mapGetters)(['getShareById'])), {}, {
    transactionTypes: function transactionTypes() {
      var _this = this;

      return _store_constants_js__WEBPACK_IMPORTED_MODULE_0__.TRANSACTION_TYPES_MAP.map(function (item, index) {
        return {
          id: index,
          label: _this.$t(item)
        };
      }).filter(function (item, index) {
        return index != _store_constants_js__WEBPACK_IMPORTED_MODULE_0__.TRANSACTION_TYPES.MergerIn;
      });
    }
  }),
  watch: {
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_7__.mapActions)(['storeTransaction'])), {}, {
    ...
    onChangeType: function onChangeType(type) {
      switch (type) {
        case _store_constants_js__WEBPACK_IMPORTED_MODULE_0__.TRANSACTION_TYPES.Bonus:
        case _store_constants_js__WEBPACK_IMPORTED_MODULE_0__.TRANSACTION_TYPES.Rights:
          this.form.preference = this.getShareById(this.form.share_id).lot;
          break;

        case _store_constants_js__WEBPACK_IMPORTED_MODULE_0__.TRANSACTION_TYPES.Dividend:
        case _store_constants_js__WEBPACK_IMPORTED_MODULE_0__.TRANSACTION_TYPES.MergerOut:
          this.form.lot = this.getShareById(this.form.share_id).lot;
          break;

        case _store_constants_js__WEBPACK_IMPORTED_MODULE_0__.TRANSACTION_TYPES.PublicOffering:
    ...
    submit: function submit() {
      ...
      if (this.$refs.form.validate()) {
        this.startLoading();
        this.storeTransaction(this.form).then(function (res) {
          (0,_utilities_helpers_js__WEBPACK_IMPORTED_MODULE_1__.parseSuccessMessage)(res);
    ...
    */
    allowedDates: function allowedDates(val) {
      return new Date(val).getDay() !== 0 && new Date(val).getDay() !== 6 && new Date(val) <= new Date();
    },
    ...
    readFromLocalStorage: function readFromLocalStorage() {
      var storageData = JSON.parse(localStorage.getItem('transactionData'));
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/partials/VCurrencyField.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/partials/VCurrencyField.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [_mixins_validationHandler_js__WEBPACK_IMPORTED_MODULE_0__.default],
  data: function data() {
    return {
      formattedValue: null
    };
...
/***/ "./resources/js/components/pages/CreateTransaction.vue":
/*!*************************************************************!*\
  !*** ./resources/js/components/pages/CreateTransaction.vue ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _CreateTransaction_vue_vue_type_template_id_20a4529c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CreateTransaction.vue?vue&type=template&id=20a4529c& */ "./resources/js/components/pages/CreateTransaction.vue?vue&type=template&id=20a4529c&");
/* harmony import */ var _CreateTransaction_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CreateTransaction.vue?vue&type=script&lang=js& */ "./resources/js/components/pages/CreateTransaction.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  _CreateTransaction_vue_vue_type_template_id_20a4529c___WEBPACK_IMPORTED_MODULE_0__.render,
  _CreateTransaction_vue_vue_type_template_id_20a4529c___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/pages/CreateTransaction.vue"
...
/***/ "./resources/js/components/partials/VCurrencyField.vue":
/*!*************************************************************!*\
  !*** ./resources/js/components/partials/VCurrencyField.vue ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _VCurrencyField_vue_vue_type_template_id_722bc2d5___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./VCurrencyField.vue?vue&type=template&id=722bc2d5& */ "./resources/js/components/partials/VCurrencyField.vue?vue&type=template&id=722bc2d5&");
/* harmony import */ var _VCurrencyField_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./VCurrencyField.vue?vue&type=script&lang=js& */ "./resources/js/components/partials/VCurrencyField.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _VCurrencyField_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _VCurrencyField_vue_vue_type_template_id_722bc2d5___WEBPACK_IMPORTED_MODULE_0__.render,
  _VCurrencyField_vue_vue_type_template_id_722bc2d5___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/partials/VCurrencyField.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/pages/CreateTransaction.vue?vue&type=script&lang=js&":
/*!**************************************************************************************!*\
  !*** ./resources/js/components/pages/CreateTransaction.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/components/partials/VCurrencyField.vue?vue&type=script&lang=js&":
/*!**************************************************************************************!*\
  !*** ./resources/js/components/partials/VCurrencyField.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VCurrencyField_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./VCurrencyField.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/partials/VCurrencyField.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VCurrencyField_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/js/components/pages/CreateTransaction.vue?vue&type=template&id=20a4529c&":
/*!********************************************************************************************!*\
  !*** ./resources/js/components/pages/CreateTransaction.vue?vue&type=template&id=20a4529c& ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CreateTransaction_vue_vue_type_template_id_20a4529c___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CreateTransaction_vue_vue_type_template_id_20a4529c___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CreateTransaction_vue_vue_type_template_id_20a4529c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CreateTransaction.vue?vue&type=template&id=20a4529c& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/CreateTransaction.vue?vue&type=template&id=20a4529c&");
...
/***/ "./resources/js/components/partials/VCurrencyField.vue?vue&type=template&id=722bc2d5&":
/*!********************************************************************************************!*\
  !*** ./resources/js/components/partials/VCurrencyField.vue?vue&type=template&id=722bc2d5& ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_VCurrencyField_vue_vue_type_template_id_722bc2d5___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_VCurrencyField_vue_vue_type_template_id_722bc2d5___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_VCurrencyField_vue_vue_type_template_id_722bc2d5___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./VCurrencyField.vue?vue&type=template&id=722bc2d5& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/partials/VCurrencyField.vue?vue&type=template&id=722bc2d5&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/CreateTransaction.vue?vue&type=template&id=20a4529c&":
/*!***********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/CreateTransaction.vue?vue&type=template&id=20a4529c& ***!
  \***********************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("v-input", {
                        ...
                        model: {
                          value: _vm.form.share_id,
                          callback: function($$v) {
                            _vm.$set(_vm.form, "share_id", $$v)
                          },
                          expression: "form.share_id"
                        }
                      }),
                      _vm._v(" "),
                      _c("v-select", {
                        ...
                        attrs: {
                          ...
                          "error-messages": _vm.getError("type"),
                          "item-text": "label",
                          "item-value": "id",
                          "menu-props": "bottom"
                        },
                                      ...
                                      _vm._b(
                                        {
                                          ...
                                          model: {
                                            value: _vm.form.date_at,
                                            callback: function($$v) {
                                              _vm.$set(_vm.form, "date_at", $$v)
                                            },
                                            expression: "form.date_at"
                                          }
                                        },
                                        "v-text-field",
                                        attrs,
                      ...
                      _vm.form.type == 3 || _vm.form.type == 4
                        ? _c("v-text-field", {
                            ...
                            attrs: {
                              ...
                              disabled: _vm.isLoading,
                              label: _vm.$t("Enter Preference Amount"),
                              rules: [_vm.rules.required],
                              "error-messages": _vm.getError("preference"),
                              hint:
                                _vm.form.type == 3
                                  ? _vm.$t(
                                      "You must write your share amount on the day of bonus."
                                    )
                                  : _vm.$t(
                                      "You must write your share amount on the day of rights."
                                    )
                            },
                            model: {
                              value: _vm.form.preference,
                              callback: function($$v) {
                                _vm.$set(_vm.form, "preference", $$v)
                              },
                              expression: "form.preference"
                            }
                          })
                        : _vm._e(),
                      _vm._v(" "),
                      _c("v-text-field", {
                        ...
                        attrs: {
                          ...
                          rules: [_vm.rules.required],
                          "error-messages": _vm.getError("lot"),
                          readonly: _vm.form.type == 5,
                          hint:
                            _vm.form.type == 3
                              ? _vm.$t("You must write your bonus shares.")
                              : _vm.form.type == 4
                              ? _vm.$t("You must write your rights shares.")
                              : ""
                        },
                        model: {
                          value: _vm.form.lot,
                      ...
                      _vm.form.type != 6
                        ? _c("v-currency-field", {
                            attrs: {
                              name: "price",
                              label: _vm.$t("Enter Transaction Price"),
                      ...
                      _vm.form.type == 5
                        ? _c("v-text-field", {
                            ...
                            attrs: {
                              ...
                              disabled: _vm.isLoading,
                              label: _vm.$t("Enter Exchange Ratio"),
                              rules: [_vm.rules.required],
                              "error-messages": _vm.getError("exchange_ratio"),
                              hint: _vm.$t("for_example", {
                                example: "1,15997"
                              })
                            },
                            model: {
                              value: _vm.form.exchange_ratio,
                              callback: function($$v) {
                                _vm.$set(_vm.form, "exchange_ratio", $$v)
                              },
                              expression: "form.exchange_ratio"
                            }
                          })
                        : _vm._e(),
                      _vm._v(" "),
                      ...
                      _vm.form.type == 7
                        ? _c("v-text-field", {
                            ...
                            attrs: {
                              ...
                              rules: [_vm.rules.required],
                              "error-messages": _vm.getError("commission"),
                              hint: _vm.$t("for_example", {
                                example: _vm.$t("Garanti Bank: 0.188")
                              })
                            },
                            model: {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/partials/VCurrencyField.vue?vue&type=template&id=722bc2d5&":
/*!***********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/partials/VCurrencyField.vue?vue&type=template&id=722bc2d5& ***!
  \***********************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c("v-text-field", {
    ...
    attrs: {
      ...
      label: _vm.label,
      rules: [_vm.rules.required],
      "error-messages": _vm.getError(_vm.name)
    },
