  ...
  <modal width="360" :dialog="showModal">
    ...
    <v-form v-model="valid" ref="transactionForm">
        ...
        <template v-else>
          ...
          >
            ...
            >
              ...
              <v-btn flat color="primary" @click="$refs.menu.save(form.date_at)"
                >OK</v-btn
              >
            </v-date-picker>
          </v-menu>
      ...
      <modal-footer>
        ...
        <v-btn color="blue darken-1" flat @click="saveTransaction">{{
          $t("Create")
        }}</v-btn>
      </modal-footer>
    </v-form>
